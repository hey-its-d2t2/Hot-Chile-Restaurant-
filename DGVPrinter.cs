...
{    
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("Palatino Linotype", 8, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("Palatino Linotype", 18, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Black;
            subtitlefont = new Font("TPalatino Linotypeahoma", 12, FontStyle.Bold, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("TahPalatino Linotypeoma", 10, FontStyle.Bold, GraphicsUnit.Point);
